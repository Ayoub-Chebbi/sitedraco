      ...
      <div className="grid gap-4 mb-8">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-green-400 mt-0.5">+216 00 000 000</p>
          </div>
        </a>

        <a
          href="mailto:support@lootstore.tn"
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-purple-400 mt-0.5">support@lootstore.tn</p>
          </div>
        </a>
      </div>
